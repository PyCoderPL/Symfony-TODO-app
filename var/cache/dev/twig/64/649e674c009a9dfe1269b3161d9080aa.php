...
class __TwigTemplate_746cf1472cbf4c6ddfbb28b22f8acc09 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(
            (isset($context["tasks"]) || array_key_exists("tasks", $context) ? $context["tasks"] : (function () {
                throw new RuntimeError('Variable "tasks" does not exist.', 25, $this->source); 
            })())
        );
                ...
                "app.add_new_task", ["listname" => twig_get_attribute(
                    $this->env, $this->source, twig_get_attribute(
                        $this->env, $this->source, (isset($context["list"]) || array_key_exists("list", $context) ? $context["list"] : (function () {
                            throw new RuntimeError('Variable "list" does not exist.', 54, $this->source); 
                        })()), 0, [], "array", false, false, false, 54
                    ), "listname", [], "any", false, false, false, 54
                )]
            ), "html", null, true
        );
        echo "\">
...
\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable(
            (isset($context["tasks"]) || array_key_exists("tasks", $context) ? $context["tasks"] : (function () {
                throw new RuntimeError('Variable "tasks" does not exist.', 78, $this->source); 
            })())
        );
        foreach ($context['_seq'] as $context["_key"] => $context["task"]) {
            // line 79
