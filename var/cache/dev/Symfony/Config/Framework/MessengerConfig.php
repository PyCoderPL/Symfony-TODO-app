...
class MessengerConfig
{
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('routing', $value)) {
            $this->_usedProperties['routing'] = true;
            $this->routing = array_map(
                function ($v) {
                    return \is_array($v) ? new \Symfony\Config\Framework\Messenger\RoutingConfig($v) : $v; 
                }, $value['routing']
            );
            unset($value['routing']);
        }
        ...
        if (array_key_exists('transports', $value)) {
            $this->_usedProperties['transports'] = true;
            $this->transports = array_map(
                function ($v) {
                    return \is_array($v) ? new \Symfony\Config\Framework\Messenger\TransportConfig($v) : $v; 
                }, $value['transports']
            );
        ...
        if (array_key_exists('buses', $value)) {
            ...
            $this->buses = array_map(
                function ($v) {
                    return new \Symfony\Config\Framework\Messenger\BusConfig($v); 
                }, $value['buses']
            );
            unset($value['buses']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['routing'])) {
            $output['routing'] = array_map(
                function ($v) {
                    return $v instanceof \Symfony\Config\Framework\Messenger\RoutingConfig ? $v->toArray() : $v; 
                }, $this->routing
            );
        }
        ...
        if (isset($this->_usedProperties['transports'])) {
            $output['transports'] = array_map(
                function ($v) {
                    return $v instanceof \Symfony\Config\Framework\Messenger\TransportConfig ? $v->toArray() : $v; 
                }, $this->transports
            );
        }
