...
class WorkflowsConfig
{
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('workflows', $value)) {
            ...
            $this->workflows = array_map(
                function ($v) {
                    return \is_array($v) ? new \Symfony\Config\Framework\Workflows\WorkflowsConfig($v) : $v; 
                }, $value['workflows']
            );
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['workflows'])) {
            $output['workflows'] = array_map(
                function ($v) {
                    return $v instanceof \Symfony\Config\Framework\Workflows\WorkflowsConfig ? $v->toArray() : $v; 
                }, $this->workflows
            );
        }
