...
class NotifierConfig
{
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('admin_recipients', $value)) {
            $this->_usedProperties['adminRecipients'] = true;
            $this->adminRecipients = array_map(
                function ($v) {
                    return new \Symfony\Config\Framework\Notifier\AdminRecipientConfig($v); 
                }, $value['admin_recipients']
            );
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['adminRecipients'])) {
            $output['admin_recipients'] = array_map(
                function ($v) {
                    return $v->toArray(); 
