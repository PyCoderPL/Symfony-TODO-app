    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ($options['expanded'] || $options['multiple']) {
            ...
            $builder->addEventListener(
                FormEvents::PRE_SUBMIT, static function (FormEvent $event) use ($choiceList, $options, &$unknownValues) {
                    $form = $event->getForm();
                    $data = $event->getData();
        ...
        if ($options['multiple']) {
            ...
            $builder->addEventListener(
                FormEvents::POST_SUBMIT, static function (FormEvent $event) use (&$unknownValues, $messageTemplate, $translator) {
        ...
        $builder->addEventListener(
            FormEvents::PRE_SUBMIT, static function (FormEvent $event) {
                $data = $event->getData();
