...
class DependencyFactory
{
    ...
    public function getVersionComparator(): Comparator
    {
        return $this->getDependency(
            Comparator::class, static function (): AlphabeticalComparator {
    ...
    {
        return $this->getDependency(
            ClassNameGenerator::class, static function (): ClassNameGenerator {
    ...
    {
        return $this->getDependency(
            SchemaDumper::class, function (): SchemaDumper {
                $excludedTables = [];
    ...
    {
        return $this->getDependency(
            EmptySchemaProvider::class, function (): SchemaProvider {
    ...
    {
        return $this->getDependency(
            SchemaProvider::class, function (): SchemaProvider {
    ...
    {
        return $this->getDependency(
            DiffGenerator::class, function (): DiffGenerator {
    ...
    {
        return $this->getDependency(
            SchemaDiffProvider::class, function (): LazySchemaDiffProvider {
    ...
    {
        return $this->getDependency(
            FileBuilder::class, static function (): FileBuilder {
    ...
    {
        return $this->getDependency(
            ParameterFormatter::class, function (): ParameterFormatter {
    ...
    {
        return $this->getDependency(
            MigrationFinder::class, function (): MigrationFinder {
    ...
    {
        return $this->getDependency(
            MigrationsRepository::class, function (): MigrationsRepository {
    ...
    {
        return $this->getDependency(
            MigrationFactory::class, function (): MigrationFactory {
    ...
    {
        return $this->getDependency(
            MetadataStorage::class, function (): MetadataStorage {
    ...
    {
        return $this->getDependency(
            Executor::class, function (): Executor {
    ...
    {
        return $this->getDependency(
            QueryWriter::class, function (): QueryWriter {
    ...
    {
        return $this->getDependency(
            AliasResolver::class, function (): AliasResolver {
    ...
    {
        return $this->getDependency(
            MigrationStatusCalculator::class, function (): MigrationStatusCalculator {
    ...
    {
        return $this->getDependency(
            MigrationPlanCalculator::class, function (): MigrationPlanCalculator {
    ...
    {
        return $this->getDependency(
            SqlGenerator::class, function (): SqlGenerator {
    ...
    {
        return $this->getDependency(
            MigratorConfigurationFactory::class, function (): MigratorConfigurationFactory {
    ...
    {
        return $this->getDependency(
            MigrationStatusInfosHelper::class, function (): MigrationStatusInfosHelper {
    ...
    {
        return $this->getDependency(
            Migrator::class, function (): Migrator {
