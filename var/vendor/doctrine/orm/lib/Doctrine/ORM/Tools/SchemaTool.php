...
class SchemaTool
{
    ...
    private function getIndexColumns(ClassMetadata $class, array $indexData): array
    {
        ...
        if (isset($indexData['columns'], $indexData['fields'])
    ...
    public function getSchemaFromMetadata(array $classes)
    {
        ...
        if (! $this->platform->supportsSchemas()) {
            $filter = /**
                       * @param Sequence|Table $asset 
                       */ static function ($asset) use ($schema): bool {
    ...
    private function createSchemaForComparison(Schema $toSchema): Schema
    {
        ...
        $config->setSchemaAssetsFilter(
            static function ($asset) use ($previousFilter, $toSchema): bool {
