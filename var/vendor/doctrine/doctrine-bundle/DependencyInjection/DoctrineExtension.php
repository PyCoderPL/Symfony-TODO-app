...
class DoctrineExtension extends AbstractDoctrineExtension
{
    ...
    protected function dbalLoad(array $config, ContainerBuilder $container)
    {
        ...
        $container->registerAttributeForAutoconfiguration(
            AsMiddleware::class, static function (ChildDefinition $definition, AsMiddleware $attribute) {
    ...
    protected function ormLoad(array $config, ContainerBuilder $container)
    {
        ...
        if (! class_exists(EntityValueResolver::class)) {
            ...
            if ($controllerResolverDefaults) {
                $container->getDefinition('doctrine.orm.entity_value_resolver')->setArgument(
...
*/
        ...
        $container->registerAttributeForAutoconfiguration(
            AsEntityListener::class, static function (ChildDefinition $definition, AsEntityListener $attribute) {
                $definition->addTag(
        ...
        $container->registerAttributeForAutoconfiguration(
            AsDoctrineListener::class, static function (ChildDefinition $definition, AsDoctrineListener $attribute) {
                $definition->addTag(
