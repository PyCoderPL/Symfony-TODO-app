...
class ORMInvalidArgumentException extends InvalidArgumentException
{
    ...
    {
        return new self(
            'A detached entity of type ' . $assoc['targetEntity'] . ' (' . self::objToStr($entry) . ') '
    ...
    {
        return new self(
            'Entity ' . self::objToStr($entity) . ' is not managed. An entity is managed if its fetched ' .
    ...
    {
        return new self(
            $context . ' expects parameter ' . $parameterIndex .
